...
public class AggregateSetUtils {
	...
	public static <T, I, F> Set<I> getIdsOfDuplicateField(@NonNull final List<T> items,
		...
		final Map<I, Set<F>> fieldSetById = items.stream()
						.collect(Collectors.groupingBy(idGetter, Collectors.mapping(getter, Collectors.toSet())));

		return MapStream.of(fieldSetById)
